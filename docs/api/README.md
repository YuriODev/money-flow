...
- [Notifications Guide](NOTIFICATIONS.md) - Telegram integration and reminders
- [API Changelog](CHANGELOG.md) - Version history and changes
- [Migration Guide](MIGRATION_V0_TO_V1.md) - Upgrading from legacy API

## API Overview

Money Flow provides a RESTful API for managing recurring payments, subscriptions, and financial tracking with an AI-powered natural language interface and Telegram notification support.
...
- **Telegram Notifications** - Payment reminders and digests
- **Calendar View** - Payment scheduling and calendar data
...
| `/api/v1/subscriptions/*` | Payment/Subscription CRUD operations |
| `/api/v1/cards/*` | Payment card management |
| `/api/v1/agent/*` | AI agent for natural language commands |
| `/api/v1/notifications/*` | Notification preferences and Telegram |
| `/api/v1/calendar/*` | Calendar view data |
| `/api/v1/analytics/*` | Spending analytics and insights |
| `/api/v1/search/*` | Semantic search across payments |
